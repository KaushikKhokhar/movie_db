...
class TopRatedDetailScreen extends StatefulWidget {
  ...
  static const routeName = 'Top-rated-detail-screen';

  @override
  State<TopRatedDetailScreen> createState() => _TopRatedDetailScreenState();
}

class _TopRatedDetailScreenState extends State<TopRatedDetailScreen> {
  double _rating = 0;
